...
class LessonAdapter(private val mContext: Context) : RecyclerView.Adapter<LessonAdapter.Holder>() {
    private lateinit var mBannerList: ArrayList<Int>
    private lateinit var mVideoList: ArrayList<LessonSet>
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        if (position == 0) {
            ...
            holder.tvTitle1?.text = lesson1.title
            holder.tvTitle2?.text = lesson2.title
    ...
    fun setVideoList(list: ArrayList<LessonSet>) {
        mVideoList = list
    }
