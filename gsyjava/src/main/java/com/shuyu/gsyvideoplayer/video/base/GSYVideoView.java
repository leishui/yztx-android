...
public abstract class GSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    public void onVideoPause() {
        ...
        try {
            if (getGSYVideoManager() != null &&
                ...
                if (mVideoAllCallBack != null) {
                    Debuger.printfLog("onMyPause");
                    mVideoAllCallBack.onMyPause(mOriginUrl, mTitle, this);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        if (mCurrentState == CURRENT_STATE_PAUSE) {
            try {
                if (mCurrentPosition >= 0 && getGSYVideoManager() != null) {
                    ...
                    if (mVideoAllCallBack != null) {
                        Debuger.printfLog("onMyResume");
                        mVideoAllCallBack.onMyResume(mOriginUrl, mTitle, this);
                    }
    ...
    public void startAfterPrepared() {
        ...
        try {
            ...
            if (mVideoAllCallBack != null) {
                Debuger.printfLog("onMyStart");
                mVideoAllCallBack.onMyStart(mOriginUrl, mTitle, this);
            }
            setStateAndUi(CURRENT_STATE_PLAYING);
